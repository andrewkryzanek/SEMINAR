...
- cat 
  - Creates a new file you can put text into 
  - Will overwrite existing files with new comments 
- unlink 
  - Deletes files and directories 
- file.rename
  - Does exactly what you think, renames files 
- file.copy
  - Moves a file from one directory to another   

**4.5: Unix-like shell commands for file management**
- This only covers the basics, to include everything would take up entirely to much space 
- 
